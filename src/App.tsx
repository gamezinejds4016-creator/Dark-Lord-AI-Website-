  ...
  return (
    <div className="app">
      <header className="header">
        <h1>Dark Lord — AI Study Bot (Local Demo)</h1>
      ...
      <footer className="footer">This demo stores everything in your browser (localStorage). To enable AI you must configure /api/ai-proxy with your GROQ_API_KEY.</footer>
    </div>
  )
}
